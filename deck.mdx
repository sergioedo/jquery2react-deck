...
```js title="Version estática, no reactiva"
import "./App.css";
...
```js title="Añadimos estado + evento con setState"
...
```js subtitle="índice de personaje como estado"
import { useState } from "react";
import "./App.css";
...
```diff 18:24 subtitle="Incluir dragón - mostrar + estado + cálculo"

```

```diff 49:63 subtitle="Incluir dragón - mostrar con CSS"
...
```diff 22:29 subtitle="estado + cálculo"
...
```diff 3:17 subtitle="función random country + valor por defecto"
...
```diff 54:63 subtitle="cálculo de impuestos"
...
- Estados + Efectos + Cálculos => <ins>**Custom Hook**</ins> <br /> (_useMiCosaDeNegocio()_)
...
```js subtitle="encapsular en función useXXXXXX"
import { useState, useEffect } from "react";
import "./App.css";
...
<Step subtitle="extracción a otro fichero">
...
```js 25,31:39 subtitle="lógica de impuestos"
import { useState } from "react";
import "./App.css";
import useRandomCountry from "./hooks/useRandomCountry";
...
<Step title="Opción de dragón">

```js 20,28 subtitle="por índice"
import { useState } from "react";
import "./App.css";
import useTaxes from "./hooks/useTaxes";
...
```js 17:20,28:34 subtitle="estado + cálculo de producto"
import { useState } from "react";
import "./App.css";
import useTaxes from "./hooks/useTaxes";
...
```js 28:42,48:73 subtitle="agrupamos la selección de producto"
import { useState } from "react";
import "./App.css";
import useTaxes from "./hooks/useTaxes";
import {
...
<Step title="Repaso patrón React ⚛️">
...
# Happy React Coding :heart::atom_symbol:!
